              ...
              >
                <div className="flex flex-col items-center space-y-2 text-white">
                  ...
                  <button
                    ...
                    className="w-full mt-3 py-2 bg-gray-900 hover:bg-gray-800 text-white rounded-full"
                  >
                    Logout
                  </button>
                  <Link to="/adminpanel" className="w-full">
                    <button
                      ...
                      className="w-full mt-2 py-2 bg-white/20 hover:bg-white/30 text-white rounded-full text-sm"
                    >
                      Dashboard
                    </button>
                  </Link>
      ...
      >
        <div className="flex flex-col h-full p-6 space-y-6">
          ...
          <Link to="/adminpanel" onClick={() => setIsOpen(false)}>
            <button className="w-full py-2 mt-4 bg-sky-300 text-gray-900 rounded-md font-semibold hover:bg-sky-400">
              Dashboard
            </button>
          </Link>
          ...
          <div className="mt-auto">
            <button
              onClick={handleLogout}
              className="w-full py-2 bg-gray-900 hover:bg-gray-700 rounded-md"
            >
