    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-r from-gray-900 to-violet-900 text-white flex items-center justify-center py-20 px-4">
        <div className="max-w-6xl w-full grid md:grid-cols-2 gap-10 rounded-xl p-8 md:p-12">
          ...
          <div>
            <h1 className="text-4xl md:text-5xl font-bold text-sky-300 mb-6 animate-fade-in-up">HTML Quiz Challenge</h1>
          ...
          <div className="flex flex-col items-center justify-center text-center gap-6">
            <h3 className="text-2xl font-semibold text-sky-300 animate-fade-in-up">Your Progress</h3>
            ...
            <div className="flex flex-col gap-4 mt-4 w-full">
              <Link to="/htmlquiz">
                <button className="w-full bg-sky-300 text-gray-900 font-semibold py-3 animate-fade-in-up rounded-lg hover:bg-sky-200 transition">
                  Start the HTML Quiz
                </button>
              </Link>
              <Link to="/quiz">
                <button className="w-full bg-gray-800 border border-gray-600 text-sky-300 py-3 animate-fade-in-up rounded-lg hover:bg-gray-700 transition">
                  Go Back
                </button>
              </Link>
            </div>
