  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center py-20 px-6">
        <h1 className="text-3xl md:text-5xl text-yellow-400 font-bold mb-6 text-center">
        ...
        <div className="bg-gray-800 shadow-lg rounded-lg p-6 max-w-xl w-full mb-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-300">
            <li>Total of 40 solid JavaScript questions</li>
        ...
        <Link to="/jsquiz">
          <button className="bg-gray-800 hover:bg-gray-700 transition duration-200 text-yellow-400 px-6 py-3 rounded-lg text-lg font-medium">
            Start Quiz
          </button>
        </Link>
        <Link to="/quiz">
          <button className="bg-gray-800 mt-5 hover:bg-gray-700 transition duration-200 text-yellow-400 px-6 py-3 rounded-lg text-lg font-medium">
            Go Back
          </button>
        </Link>
      </div>
